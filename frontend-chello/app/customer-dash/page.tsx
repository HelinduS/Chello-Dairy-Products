  ...
  return (
    <>
          ...
          {products.length === 0 ? (
            ...
            <>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex justify-between items-center mt-1">
                        <p className="text-sm text-gray-500">
                          ${(product.totalPrice / product.quantity).toFixed(2)} each
                        </p>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4">
                ...
                <Button
                  variant="default"
                  className="py-3 text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200 flex items-center justify-center gap-2"
      ...
      <MapCard
        ...
        deliveryDay={title as "Wednesday" | "Sunday"}
      />
    </>
  )
}
      ...
      <div className="flex flex-1">
        <aside className="w-30 border-r p-4 bg-muted">
          <nav className="space-y-2">
            <Link
              href="/profile"
              className="flex flex-col items-center space-y-1 text-primary hover:underline"
            >
