    ...
    return (
        <>
            ...
            <aside
                ...
                } transition-transform md:translate-x-0 md:flex md:flex-col h-screen z-50`}
            >
                <button
                ...
                <nav className="flex-1 p-4">
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link href="/deliverydashboard" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800">
                                <Truck size={18} />
                        ...
                        <li>
                            <Link href="/admindas/products" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-800">
